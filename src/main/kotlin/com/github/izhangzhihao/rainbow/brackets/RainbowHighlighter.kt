...
object RainbowHighlighter {
    ...
    private val defaultRoundBracketsColors: Array<Color> = arrayOf(
    ...
    private val defaultSquareBracketsColors: Array<Color> = arrayOf(
            JBColor(0x0B9087, 0x33CCFF),
            JBColor(0x6444E6, 0x8080FF),
            JBColor(0x00599B, 0x0073A8)
    )
    private val defaultSquigglyBracketsColors: Array<Color> = arrayOf(
    ...
    private fun createTextAttributes(element: PsiElement, level: Int): TextAttributes? {
        ...
        val color = when {
            ...
            isEnableRainbowSquigglyBrackets && element.isSquareBracket -> defaultSquareBracketsColors
            isEnableRainbowSquareBrackets && element.isSquigglyBracket -> defaultSquigglyBracketsColors
